package com.banksystem.account.application.common;
...
public class OpsAlertPublisher {
  ...
  public static final String TEMPLATE_CARD_REQUESTED = "OPS_CARD_REQUESTED";
  ...
  public void cardRequested(com.banksystem.account.domain.entity.card.CardEntity card, String accountNumber) {
    UUID eventId = UUID.nameUUIDFromBytes(
        (TEMPLATE_CARD_REQUESTED + ":" + card.getId() + ":" + card.getCreatedAt())
            .getBytes(StandardCharsets.UTF_8));
    String body = "Yêu cầu mở thẻ mới cho tài khoản: " + (accountNumber != null ? accountNumber : card.getAccountId());
    publishQuietly(eventId, TEMPLATE_CARD_REQUESTED, body);
  }
