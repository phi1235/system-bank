...
@Entity
@Table(name = "remediation_outbox_events")
public class RemediationOutboxEntity {
  ...
  protected RemediationOutboxEntity() {}

  public static RemediationOutboxEntity create(
      UUID id, UUID aggregateId, String eventType, int schemaVersion, String payload, Instant now) {
    RemediationOutboxEntity entity = new RemediationOutboxEntity();
