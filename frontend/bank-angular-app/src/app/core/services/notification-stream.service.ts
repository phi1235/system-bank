 ...
 * Uses fetch + ReadableStream so we can send Authorization header
...
export class NotificationStreamService implements OnDestroy {
  ...
  private async open(): Promise<void> {
    ...
    try {
      const res = await fetch(`${environment.apiUrl}/notifications/stream`, {
        method: 'GET',
        headers: {
  ...
  /** Parse complete SSE frames from buffer; return remainder. */
