...
export const RBAC_SCREENS: RbacScreenDef[] = [
  ...
  },
  {
    ...
    features: [
      ...
      {
        id: 'forensics',
        labelKey: 'ADMIN.FEAT_FORENSICS',
        label: 'Điều tra tài chính',
        actions: { view: PERMISSIONS.FORENSICS_VIEW },
      },
      {
        id: 'forensics-verification',
        labelKey: 'ADMIN.FEAT_FORENSICS_VERIFY',
        label: 'Chạy xác minh',
        actions: { execute: PERMISSIONS.FORENSICS_VERIFY_EXECUTE },
      },
      {
        id: 'forensics-cases',
        labelKey: 'ADMIN.FEAT_FORENSICS_CASES',
        label: 'Quản lý hồ sơ điều tra',
        actions: { manage: PERMISSIONS.FORENSICS_CASE_REVIEW },
      },
      {
        id: 'forensics-evidence',
        labelKey: 'ADMIN.FEAT_FORENSICS_EVIDENCE',
        label: 'Xuất bằng chứng',
        actions: { execute: PERMISSIONS.FORENSICS_EVIDENCE_EXPORT },
      },
      {
        id: 'forensics-replay',
        labelKey: 'ADMIN.FEAT_FORENSICS_REPLAY',
        label: 'Chạy replay',
        actions: { execute: PERMISSIONS.FORENSICS_REPLAY_EXECUTE },
      },
      {
        id: 'forensics-copilot',
        labelKey: 'ADMIN.FEAT_FORENSICS_COPILOT',
        label: 'Sử dụng AI Copilot',
        actions: { execute: PERMISSIONS.FORENSICS_COPILOT_USE },
      },
      {
        id: 'forensics-audit',
        labelKey: 'ADMIN.FEAT_FORENSICS_AUDIT',
        label: 'Xem lịch sử điều tra',
        actions: { view: PERMISSIONS.FORENSICS_AUDIT_VIEW },
      },
      {
        id: 'forensics-admin',
        labelKey: 'ADMIN.FEAT_FORENSICS_ADMIN',
        label: 'Quản trị điều tra',
        actions: { manage: PERMISSIONS.FORENSICS_ADMIN },
      },
      {
        id: 'deposits',
